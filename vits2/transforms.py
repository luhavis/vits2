...
def piecewise_rational_quadratic_transfrom(
    inputs,
    unnormalized_widths,
...
def unconstrained_rational_quadratic_spline(
    ...
    (outputs[inside_interval_mask], logabsdet[outside_interval_mask]) = rational_quadratic_spline(
        inputs=inputs[inside_interval_mask],
        unnormalized_widths=unnormalized_widths[inside_interval_mask, :],
        unnormalized_heigths=unnormalized_heigths[inside_interval_mask, :],
...
def rational_quadratic_spline(
    ...
    derivatives = min_derivative + F.softmax(unnormalized_derivatives)
